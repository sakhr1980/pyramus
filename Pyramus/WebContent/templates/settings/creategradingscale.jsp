    ...
    <script type="text/javascript">
       ...
       function onLoad(event) {
         ...
         var gradesTable = new IxTable($('gradesTableContainer'), {
           id : "gradesTable",
           columns : [{
             header : '<fmt:message key="settings.createGradingScale.gradesTablePassingGradeHeader"/>',
             width: 82,
             left : 9,
             dataType: 'checkbox',
             editable: true,
             ...
             header : '<fmt:message key="settings.createGradingScale.gradesTableNameHeader"/>',
             left : 98,
             width : 236,
             dataType: 'text',
             editable: true,
             ...
             header : '<fmt:message key="settings.createGradingScale.gradesTableGPAHeader"/>',
             left : 518,
             width : 50,
             dataType : 'number',
             editable: true,
             ...
             header : '<fmt:message key="settings.createGradingScale.gradesTableDescriptionHeader"/>',
             left: 572,
             right: 28,
             dataType: 'text',
             editable: true,
