...
public class SearchModulesJSONRequestController implements JSONRequestController {
  ...
  public void process(JSONRequestContext requestContext) {
    ...
    String projectName = requestContext.getRequest().getParameter("projectName");

    // Search via the DAO object

    SearchResult<Module> searchResult = moduleDAO.searchModules(resultsPerPage, page, projectName, text, text, text,
